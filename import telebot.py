...
def favorites_handler(message):
    ...
    if message.text == 'Чарты VK и поиск песен 🔥':
        bot.send_message(message.from_user.id,'Поиск, просмотр чартов ВК и загрузка music по ' + '[👉тут👈](t.me/roskoshnyihubbot)',
                     parse_mode='Markdown')
...
def settings_handler(message):
    if message.text == 'Support':
        bot.send_message(message.from_user.id,'Если у вас возникли трудности, или хотели бы добавить что то в этом боте. ' + '[Tech support:](https://t.me/c/1289203224/5896)',
                     parse_mode='Markdown')
